...
import static com.example.mobile_aris.Classes.Appointments.cancelled_tab.EXTRA_CLINIC;
import static com.example.mobile_aris.Classes.Appointments.cancelled_tab.EXTRA_DATE;
import static com.example.mobile_aris.Classes.Appointments.cancelled_tab.EXTRA_PURPOSE;
import static com.example.mobile_aris.Classes.Appointments.cancelled_tab.EXTRA_STATUS;
import static com.example.mobile_aris.Classes.Appointments.cancelled_tab.EXTRA_TIME;
...
public class CancelledDetailActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Dialog dialog = new Dialog(CancelledDetailActivity.this);
        dialog.setContentView(R.layout.cancelled_activity_detail);
        dialog.setTitle("Cancelled Detail");
...
//                PendingDetailActivity.this.startActivity(intent);
                CancelledDetailActivity.this.onBackPressed();
            }
        });
